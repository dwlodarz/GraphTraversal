...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    /***/ function (module, exports) {
        ...
        module.exports = "<div class=\"events-list\" ng-show=\"day.events.length <= 0\" ng-click=\"vm.calendarCtrl.addClick(day)\"><i class=\"glyphicon glyphicon-plus\"></i></div><div class=\"events-list\" ng-show=\"day.events.length > 0\">\n  <a\n    ng-repeat=\"event in day.events | orderBy:'startsAt' track by event.$id\"\n    href=\"javascript:;\"\n    ng-click=\"vm.onEventClick({calendarEvent: event})\"\n    class=\"pull-left event\"\n    ng-class=\"'event-' + event.type + ' ' + event.cssClass\"\n    ng-mouseenter=\"vm.highlightEvent(event, true)\"\n    ng-mouseleave=\"vm.highlightEvent(event, false)\"\n    tooltip-append-to-body=\"true\"\n    uib-tooltip-html=\"((event.startsAt | calendarDate:'time':true) + (vm.calendarConfig.displayEventEndTimes && event.endsAt ? ' - ' + (event.endsAt | calendarDate:'time':true) : '') + ' - ' + event.title) | calendarTrustAsHtml\"\n    mwl-draggable=\"event.draggable === true\"\n    drop-data=\"{event: event}\">\n  </a>\n</div>\n";
        // module.exports = "<div class=\"events-list\">\n <div class=\"container-fluid\"><div class=\"row\"><div class=\"col-md-6\"> <a\n   ng-show=\"day.events.length > 0\"  ng-repeat=\"event in day.events | orderBy:'startsAt' track by event.$id\"\n    href=\"javascript:;\"\n    ng-click=\"vm.onEventClick({calendarEvent: event})\"\n    class=\"pull-left event\"\n    ng-class=\"'event-' + event.type + ' ' + event.cssClass\"\n    ng-mouseenter=\"vm.highlightEvent(event, true)\"\n    ng-mouseleave=\"vm.highlightEvent(event, false)\"\n    tooltip-append-to-body=\"true\"\n    uib-tooltip-html=\"((event.startsAt | calendarDate:'time':true) + (vm.calendarConfig.displayEventEndTimes && event.endsAt ? ' - ' + (event.endsAt | calendarDate:'time':true) : '') + ' - ' + event.title) | calendarTrustAsHtml\"\n    mwl-draggable=\"event.draggable === true\"\n    drop-data=\"{event: event}\">\n  </a></div><div class=\"col-md-6\"><i class=\"glyphicon glyphicon-plus\"></i></div></div></div></div>\n</div>\n";
        // module.exports = "<div class=\"container-fluid\"> <div class=\"row\"> <div class=\"col-md-6\"> <div class=\"events-list\">\n  <a\n   ng-show=\"day.events.length > 0\"  ng-repeat=\"event in day.events | orderBy:'startsAt' track by event.$id\"\n    href=\"javascript:;\"\n    ng-click=\"vm.onEventClick({calendarEvent: event})\"\n    class=\"pull-left event\"\n    ng-class=\"'event-' + event.type + ' ' + event.cssClass\"\n    ng-mouseenter=\"vm.highlightEvent(event, true)\"\n    ng-mouseleave=\"vm.highlightEvent(event, false)\"\n    tooltip-append-to-body=\"true\"\n    uib-tooltip-html=\"((event.startsAt | calendarDate:'time':true) + (vm.calendarConfig.displayEventEndTimes && event.endsAt ? ' - ' + (event.endsAt | calendarDate:'time':true) : '') + ' - ' + event.title) | calendarTrustAsHtml\"\n    mwl-draggable=\"event.draggable === true\"\n    drop-data=\"{event: event}\">\n  </a></div></div>   <div class=\"col-md-6\"><i class=\"glyphicon glyphicon-plus\"></i></div></div>\n</div>\n";
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        angular
          ...
          .controller('MwlCalendarCtrl', ["$scope", "$log", "$timeout", "$attrs", "$locale", "moment", "calendarTitle", function ($scope, $log, $timeout, $attrs, $locale, moment, calendarTitle) {
              ...
              vm.addClick = function (data)
              {
                  vm.onAddClick({ calendarEvent: data.date });
              }
